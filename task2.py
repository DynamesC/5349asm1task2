...
if __name__ == "__main__":
    ...
    checkList = ["BEePFpC9qG8", "RmZ3DPJQo2k", "1Aoc-cd9eYs", "QwZT7T-TXT0"]
    ...
    final = sc.parallelize(result.sortBy(lambda r: r[1], False).filter(lambda r: r[0] in checkList).take(10))
